    ...
    <div class="row">
        ...
        <div class="col-md-8" style="margin-top: 60px;">
            ...
            <form action="/addnew" method="post">
                <input type="hidden" name="author" value="<%=usersData.getId()%>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="content" id = "short_content"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select" name="language">
                            <%
                            ArrayList<News_Language> allLanguages= (ArrayList<News_Language>) request.getAttribute("allLanguage");
                            if (allLanguages!=null){
                                for (News_Language language : allLanguages){
                                    %>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-primary float-right">Save New</button>
                    </div>
                </div>
            </form>
